...
public class SimulatorView extends JFrame
{
    ...
    private final String WEATHER_POSTFIX = "Days Left: ";
    ...
    public void showStatus(int step, Field field)
    {
        ...
        weatherLabel.setText(WEATHER_PREFIX + field.getWeather() + "- " + WEATHER_POSTFIX + field.getWeatherDay());
        timeLabel.setText("Time: " + field.getHours() + ":" + field.getMinutes());
        fieldView.repaint();
    }
